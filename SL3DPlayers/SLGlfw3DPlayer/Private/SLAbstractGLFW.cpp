...
void SLAbstractGLFW::ShowWidget()
{
	initGlfwGlewGL();
...
SLAbstractGLFW* currentInstance;
...
void SLAbstractGLFW::keyboardRegister()
{
	::currentInstance = this;
	::glfwSetKeyCallback(m_WidgetGLFW, _KeyDetection);

}

void SLAbstractGLFW::keyDetection(GLFWwindow* widget, int key, int scancode, int action, int mode)
{
